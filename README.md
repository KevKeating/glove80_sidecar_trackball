...
1. Remove the mouse wheel from the mouse buttons PCB.  Pull the mouse wheel gently away from the encoder (the silver thing that it's mounted in) and it should pop out.
...
1. Attach the mouse button shell to the mouse button back wall with four M2.5x8mm screws: three screws go in from the back side of the mouse buttons back wall and one screw goes in from the bottom side of the mouse button shell.  Make sure that you don't overtighten the screws, as that will prevent the buttons from moving correctly.  Give all of the buttons a few test clicks.  If they bind up or rub, try loosening the screws a bit.
